    ...
    <div class="chamado" style="height: 120%;">
        ...
        <div id="form-chamado">
            <form method="POST" action="">
                ...
                <div class=" itens">
                    <div class="arrumar">
                        <p>Número do chamado <input class="form-control" type="text" name="chamado" size="25px"
                                maxlength="100"></p>
                        ...
                        <p>Data de Abertura <input class="form-control" type="text" name="data" size="25px"
                                maxlength="100"></p>
            ...
            <div class="direita">
                ...
                <form action="" method="POST">
                    ...
                    <p>Telefone do cliente <input class="form-control" type="text" name="Telefone" size="25px"
                            maxlength="100"></p>
                    ...
                    <p> Data Fechamento <input class="form-control" type="text" name="defeito" size="25px"
                            maxlength="100"></p>
                ...
                <div class=" itens">
                    <div class="arrumar">
                        <p>
                                ...
                                <input class="form-control" value="" id="codTomb" type="text" id="CodigoTombamento" name="CodigoTombamento" size="25px"
              maxlength="100">
  ...
  -->
        ...
        <div class="esquerda">
            <div class="list-group" id="list-tab" role="tablist">
                <a class="list-group-item list-group-item-action active" id="Chamado" data-toggle="list" href="#"
                    role="tab" aria-controls="Chamado">Chamado</a>
                <a class="list-group-item list-group-item-action" id="Processamento" data-toggle="list" href="#"
                    role="tab" aria-controls="Processamento">Processamento</a>
                <a class="list-group-item list-group-item-action" id="Encaminhar" data-toggle="list" href="#" role="tab"
                    aria-controls="Encaminhar">Encaminhar</a>
                <a class="list-group-item list-group-item-action" id="Tombamento" data-toggle="list" href="#" role="tab"
                    aria-controls="Tombamento">Tombo de Patrimônio</a>
                <a class="list-group-item list-group-item-action" id="Finalizar" data-toggle="list" href="#" role="tab"
