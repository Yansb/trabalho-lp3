...
<head>
    ...
    <!-- NÃO retirem essa linha <link rel="stylesheet" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css"> -->
...
<body>
    ...
    <h1>Erro: Ação impossível de ser realizada</h1>
