  ...
  <div class="pesquisa id=">
    ...
    <form action="../Controller/ControladorChamados.php" method="POST">
      ...
      <div class="divEsquerda">
        <p>
          <p>Pesquisar por:</p>
          <select class="custom-select custom-select-lg mb-3" name="PesqUsuario" id="ids" onchange="mostraOculta('ids');">
      ...
      <p>Digite o Numero</p> <input class="form-control" type="number" name="Numero2" id="Numero" />
      </div>
    ...
    <div class="chamados">
      ...
      <section>
        <table class="table">
          ...
          $Resultado = $Chamado->BuscarUsuario($_SESSION["Usuario"],$_SESSION['Tipo']);
